...
unsigned char BIENVENIDA[] = {
    ...
    0x00, 0x7E, 0x7E, 0x5A, 0x5A, 0x7E, 0x3C, 0x00,
...
unsigned char GANADOR[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x7E, 0x7E, 0x46, 0x56, 0x76, 0x76, 0x00,
    0x00, 0x7E, 0x7E, 0x1A, 0x1A, 0x7E, 0x7E, 0x00,
    0x00, 0x7E, 0x7E, 0x0C, 0x18, 0x7E, 0x7E, 0x00,
    0x00, 0x7E, 0x7E, 0x1A, 0x1A, 0x7E, 0x7E, 0x00,
    0x00, 0x7E, 0x7E, 0x66, 0x66, 0x7E, 0x3C, 0x00,
    0x00, 0x7E, 0x7E, 0x66, 0x66, 0x7E, 0x7E, 0x00,
    0x00, 0x7E, 0x7E, 0x12, 0x12, 0x3E, 0x6C, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};

unsigned char MODO_FACIL[]   = {0x00, 0x7E, 0x7E, 0x16, 0x16, 0x16, 0x06, 0x00};
unsigned char MODO_NORMAL[]  = {0x00, 0x7E, 0x7E, 0x0C, 0x18, 0x7E, 0x7E, 0x00};
unsigned char MODO_DIFICIL[] = {0x00, 0x7E, 0x7E, 0x66, 0x66, 0x7E, 0x3C, 0x00};
...
unsigned char PUNTOS[] = {
    ...
    0x00, 0x7E, 0x7E, 0x60, 0x60, 0x7E, 0x7E, 0x00,
    0x00, 0x7E, 0x7E, 0x0C, 0x18, 0x7E, 0x7E, 0x00,
    0x00, 0x06, 0x06, 0x7E, 0x7E, 0x06, 0x06, 0x00,
    0x00, 0x7E, 0x7E, 0x66, 0x66, 0x7E, 0x7E, 0x00,
    0x00, 0x5E, 0x5E, 0x56, 0x76, 0x76, 0x76, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
...
void estado_puntuacion(int puntos){
    ...
    for(int i = 0; i < 64; i++) buffer[tam++] = PUNTOS[i];
    for(int i = 0; i < 8; i++)  buffer[tam++] = 0x00;
